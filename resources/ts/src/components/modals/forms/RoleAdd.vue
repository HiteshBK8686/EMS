<template>
  ...
  <div class="modal fade" id="kt_modal_new_role" ref="newTargetModalRef" tabindex="-1" aria-hidden="true">
    <!--begin::Modal dialog-->
        ...
        <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
          ...
          <el-form id="kt_modal_new_target_form" @submit.prevent="submit()" :model="targetData" :rules="rules"
            ...
            <div class="mb-13 text-center">
              <!--begin::Title-->
              <h1 class="mb-3">Add New Role and Permissions</h1>
              <!--end::Title-->
            </div>
            <!--end::Heading-->
            ...
            <div class="d-flex flex-column mb-4 fv-row">
              ...
              <el-form-item prop="name">
                <el-input v-model="targetData.name" placeholder="Enter Role Title" name="name"></el-input>
              </el-form-item>
            </div>
            <!--end::Input group-->
            <!--begin::Checkboxes-->
            ...
            <div class="d-flex align-items-center mb-8">
              ...
              <div v-for="permission in get_permission" :key="permission.id">
                <label class="form-check form-check-custom form-check-solid me-10">
                  <input class="form-check-input h-20px w-20px" type="checkbox" v-model="targetData.permission"
                    :value="permission.id" />
...
export default defineComponent({
  ...
  setup(props,ctx) {
    ...
    const submit = async (values: any) => {
      ...
      // Send login request
      await store.rolePermissionAdd(values);
